...
func (c *userManagmentClient) CreateNewUser(ctx context.Context, in *NewUser, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/usermgmtl.UserManagment/CreateNewUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagmentClient) GetUsers(ctx context.Context, in *GetUsersParams, opts ...grpc.CallOption) (*UsersList, error) {
	out := new(UsersList)
	err := c.cc.Invoke(ctx, "/usermgmtl.UserManagment/GetUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserManagment_CreateNewUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/usermgmtl.UserManagment/CreateNewUser",
	}
...
func _UserManagment_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/usermgmtl.UserManagment/GetUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var UserManagment_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "usermgmtl.UserManagment",
